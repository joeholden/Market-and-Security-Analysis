...
def scrape_wsj_market_breadth():
    ...
    table_date = driver.find_element(by=By.XPATH,
                                     value='//*[@id="root"]/div/div/div/div[2]/div/div/div[2]/div[1]/h3/span[2]')
    date_string = table_date.text
    date_format = "%A, %B %d, %Y"
    datetime_object = datetime.strptime(date_string, date_format)
    datetime_date = datetime_object.date()
    if datetime_date == datetime.today():
